...
public class SysPostController extends BaseController {
    ...
    @PostMapping("/list")
    public TableDataInfo list(@RequestBody(required = false) SysPost post) {
        //startPage();
    ...
    @PostMapping("/export")
    public AjaxResult export(@RequestBody(required = false) SysPost post) {
        List<SysPost> list = postService.selectPostList(post);
    ...
    @PostMapping(value = "/query/{postId}")
