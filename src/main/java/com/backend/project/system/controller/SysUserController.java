...
public class SysUserController extends BaseController {
    ...
    @PostMapping("/list")
    public TableDataInfo list(@RequestBody(required = false) SysUser user) {
        //startPage(user);
    ...
    @PostMapping("/export")
    public AjaxResult export(@RequestBody(required = false) SysUser user) {
        List<SysUser> list = userService.selectUserList(user);
    ...
    public static void main(String[] args) {
        System.out.println(SecurityUtils.encryptPassword("Aa123123"));
    }
     ...
     * 获取用户分配任务详情列表
     */
    //@PreAuthorize("@ss.hasPermi('system:user:allotTaskList')")
    @PostMapping("/allotTaskList")
    public AjaxResult allotTaskList(@RequestBody(required = false) SysUser user) {
        //startPage(user);
        List<SysUser> list = userService.allotTaskList(user);
