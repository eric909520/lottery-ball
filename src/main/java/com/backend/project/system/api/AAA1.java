...
public class AAA1 {
    ...
    public static void main(String[] args) {
        ...
        double betAmountZero = 4800;
        double oddsZero = 11;

        double betAmountOne = 11000;
        double oddsOne = 4.8;

        double betAmountTwo = 10900;
        double oddsTwo = 3.5;
        ...
        double betAmountLarge = 29700;
        double oddsLarge = 0.75;
        ...
        System.out.println("皇冠3，4，5，6，7+数据++++++++++");
