...
public class EEE {
    ...
    public static void main(String[] args) {
        ...
        Double reward4 = CalcUtil.sub(CalcUtil.add(bonusFour, rebateSPAmount, rebateHGAmountAll), betAmountFour, betAmountFive, betAmountSix, betAmountSeven, betAmountSmall);
        ...
        /** 皇冠中球 */
        double bonusSmallHalf = CalcUtil.div(CalcUtil.mul(betAmountSmall, oddsSmall), 2); // 奖金
        double bonusSmall = CalcUtil.mul(betAmountSmall, oddsSmall); // 奖金

        // 皇冠返水 - 皇冠中球返水 按出奖金额作为基础金额
        double rebateHGAmount1 = CalcUtil.mul(bonusSmallHalf, rebateHG);
        double rebateHGAmount2 = CalcUtil.mul(bonusSmall, rebateHG);

        Double rewardSmall1 = CalcUtil.sub(CalcUtil.add(bonusSmallHalf, rebateSPAmount, rebateHGAmount1), betAmountFour, betAmountFive, betAmountSix, betAmountSeven);
        System.out.println("皇冠中3球数据++++++++++");
        System.out.println("奖金：" + bonusSmallHalf);
        System.out.println("体彩返水：" + rebateSPAmount);
        System.out.println("皇冠返水：" + rebateHGAmount1);
        System.out.println("收益：" + rewardSmall1);
