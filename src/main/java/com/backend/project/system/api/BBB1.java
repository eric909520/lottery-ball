...
public class BBB1 {
    ...
    public static void main(String[] args) {
        ...
        double betAmountZero = 2764;
        double oddsZero = 17;

        double betAmountOne = 7230;
        double oddsOne = 6.5;

        double betAmountTwo = 12207;
        double oddsTwo = 3.85;

        double betAmountThree = 12861;
        double oddsThree = 3.65;

        System.out.println("体彩总下注：" + CalcUtil.add(betAmountOne, betAmountTwo, betAmountThree));

        // 皇冠参数
        // 皇冠返水比例
        double rebateHG = 0.024;

        double betAmountLarge = 25400;
        double oddsLarge = 0.85;
